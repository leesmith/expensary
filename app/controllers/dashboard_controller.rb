class DashboardController < ApplicationController
  def index
    ...
    SQL
    @total_income = Transaction.find_by_sql(total_income_sql).first.total_income.to_i
    ...
    total_expense_sql = <<~SQL
      ...
      AND transactions.tran_date < '#{@date_filter.end_of_month}';
    SQL
    @total_expenses = Transaction.find_by_sql(total_expense_sql).first.total_expenses.to_i
